...
const copy:Record<Locale,{title:string;body:string;share:string;email:string;shared:string;failed:string;subject:string;message:string}>={
  tr:{title:'Arkadaşını davet et',body:'Gerçek ev ve yaşam mağazalarını birlikte keşfedin',share:'Site bağlantısını paylaş',email:'E-posta ile davet et',shared:'Bağlantı kopyalandı',failed:'Bağlantı kopyalanamadı',subject:'Boşa Gezme!’ye davet',message:'Gerçek ev ve yaşam mağazalarını birlikte keşfedelim: https://bosagezme.com'},
  en:{title:'Invite a friend',body:'Discover real home and living stores together',share:'Share the website',email:'Invite by email',shared:'Link copied',failed:'Could not copy the link',subject:'An invitation to Boşa Gezme!',message:'Let’s discover real home and living stores together: https://bosagezme.com'},
