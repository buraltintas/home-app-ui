...
//
// A store page is cached for an hour, which is right for a page that is mostly an address
// and mostly does not change -- and wrong for the moment a review lands on it. The reviewer
// was sent back to the shop and could not see what they had just written: the page they
// arrived at had been rendered before they wrote it, and stayed that way for up to an hour.
