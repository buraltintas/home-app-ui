...
export type Store = { id:string;name:string;slug:string;is_premium?:boolean;brand_name?:string;address:string;city:string;district:string;phone?:string;latitude:number;longitude:number;distance_meters?:number;categories:string[];category_labels:string[];localized_description?:string;platform:PlatformStats;viewer_has_favorited:boolean;viewer_has_reviewed:boolean;photo?:StoredPhoto;external_sources?:{provider:'google';external_id:string;attribution:Record<string,unknown>;refreshed_at?:string}[] };
